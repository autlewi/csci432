...
const _hoisted_7 = { id: "fig1" };
const _hoisted_8 = /* @__PURE__ */ createBaseVNode("img", { id: "preview-img" }, null, -1);
const _hoisted_9 = { class: "form-floating mb-2" };
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("label", {
  for: "username",
  class: "form-label"
}, "Username", -1);
const _hoisted_11 = { clas: "form-floating mb-2" };
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("label", {
  for: "email",
  class: "form-label"
}, "Email", -1);
const _hoisted_13 = { clas: "form-floating mb-2" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    watch(emailRef, () => {
      ...
      console.log(count++);
      usernameRef.value.value = "alewis3@eagles.bridgewater.edu";
    });
    ...
    function componentUpdate(elm2) {
      console.log("password changed");
      console.log(elm2.value);
      console.log(passwordErrorRef.value);
      if (passwordErrorRef.value != null && elm2.value.length > 0) {
        validPassword.value = elm2.value.length >= 8;
        passwordErrorRef.value.innerHTML = validPassword.value ? "&nbsp;" : "Minimum length: 8 characters, atleast one upper and lowercase letter, and atleast 1 special character(ex.@#!)";
      }
    }
    watch(username, () => {
    ...
    watch(email, () => {
      if (emailErrorRef.value != null && elm.value.length > 0) {
        emailErrorRef.value.innerHTML = validEmail.value ? "&nbsp;" : "Please enter a vailid email address";
      }
    ...
    watch([validUsername, validPassword, passwordsMatch], async () => {
      disabled.value = !(validUsername.value && validPassword.value && passwordsMatch.value && validEmail.value);
            ...
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("div", _hoisted_6, [
                createBaseVNode("figure", _hoisted_7, [
                  _hoisted_8,
                  createBaseVNode("figcaption", null, toDisplayString(avatarImageFile.value.name), 1)
                ])
              ])
            ]),
