...
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("br", null, null, -1));
const _sfc_main$3 = {
  __name: "Form",
  props: ["title", "info"],
  emits: ["update:info", "addRecord"],
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", null, [
        createBaseVNode("fieldset", null, [
          createBaseVNode("legend", null, toDisplayString(__props.title), 1),
          createBaseVNode("div", null, [
            withDirectives(createBaseVNode("input", {
              id: "name",
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(values).name = $event)
            }, null, 512), [
              [vModelText, unref(values).name]
            ]),
            _hoisted_1$2,
            _hoisted_2$1,
            withDirectives(createBaseVNode("input", {
              id: "email",
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(values).email = $event)
            }, null, 512), [
              [vModelText, unref(values).email]
            ]),
            _hoisted_3$1,
            _hoisted_4$1,
            createBaseVNode("button", {
              type: "button",
              onClick: _cache[2] || (_cache[2] = ($event) => _ctx.$emit("addCard"))
            }, "submit")
          ])
        ])
      ]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("p", null, " Name: " + toDisplayString(name.value), 1),
        createBaseVNode("p", null, " Email: " + toDisplayString(email.value), 1)
      ]);
    };
  }
};
const CardwForm_vue_vue_type_style_index_0_lang = "";
const _hoisted_1 = { id: "forms" };
const _hoisted_2 = { id: "list" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("span", null, "Submitted Information", -1);
      ...
      return openBlock(), createElementBlock("main", null, [
        createBaseVNode("section", _hoisted_1, [
          createVNode(Form, {
            title: "Interest Form",
            info: userInfo.value,
            "onUpdate:info": _cache[0] || (_cache[0] = ($event) => userInfo.value = $event),
            onAddCard: addInfo
          }, null, 8, ["info"])
        ]),
        createBaseVNode("section", _hoisted_2, [
          ...
          createTextVNode(),
          _hoisted_4,
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(cardInfo), (card) => {
            return openBlock(), createElementBlock("div", null, [
              createBaseVNode("span", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(cardInfo), (card2, index) => {
