...
var createScene = function() {
  var scene2 = new B.Scene(engine);
  scene2.gravity = new BABYLON.Vector3(0, -9.81, 0);
  ...
  light.intensity = 0.4;
  let skybox = B.Mesh.CreateBox("skyBox", 1e3, scene2);
  skybox.position.y = 0;
  skybox.infiniteDistance = true;
  let skyboxMaterial = new B.StandardMaterial("skyBoxMat", scene2);
  ...
  ground.position.y = 0;
  let materialground = new B.StandardMaterial("ground", scene2);
  materialground.diffuseTexture = new BABYLON.Texture("ground.jpg", scene2);
  ...
  BABYLON.SceneLoader.ImportMesh(
    ...
    function(meshes, particalSystem, skeletons) {
      ...
      for (let mesh of meshes) {
        ...
        mesh.position.z = -12;
        mesh.position.x = -0.6;
        mesh.scaling = new B.Vector3(0.2, 0.2, 0.2);
      }
  ...
  BABYLON.SceneLoader.ImportMesh(
    ...
    function(meshes, particalSystem, skeletons) {
      ...
      for (let mesh of meshes) {
        ...
        mesh.position.x = 20;
        mesh.position.z = 10;
        mesh.scaling = new B.Vector3(0.3, 0.3, 0.3);
      }
      let pizza = meshes[0];
      for (let i = 1; i < meshes.length; i++) {
  ...
  BABYLON.SceneLoader.ImportMesh(
    ...
    function(meshes, particalSystem, skeletons) {
      ...
      for (let mesh of meshes) {
        ...
        mesh.position.x = 20;
        mesh.position.z = 10;
        mesh.scaling = new B.Vector3(0.18, 0.18, 0.18);
      }
      let cup = meshes[0];
      for (let i = 1; i < meshes.length; i++) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Scene = resolveComponent("Scene");
  return openBlock(), createBlock(_component_Scene);
}
